            ...
            if (campaignId) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        // Tính và gán số ngày khi đã có start và end
                        ...
                        const displayStart = moment(data.start).format('DD-MM-YYYY HH:mm');
                        const displayEnd = moment(data.end).format('DD-MM-YYYY HH:mm');
                        $('#timeRangeDisplay').text(`Thời gian từ ${displayStart} đến ${displayEnd}`);
