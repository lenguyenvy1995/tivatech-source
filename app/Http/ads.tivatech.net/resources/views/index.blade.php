...
<head>
    ...
    <title>TIVATECH</title>
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="{{ asset('logov.png') }}" />
    <!-- Bootstrap Icons-->
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="#page-top">
                <img src="{{ asset('logo.png') }}" alt="tivatech" srcset="" width="200px">
            </a>
        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                ...
                <div class="col-lg-8 align-self-baseline">
                    ...
                    <a href="{{ url('auth/google') }}" class="btn btn-google btn-primary btn-xl" style="background:#4285f4">
                        <span>
                            <img width="30px" src="https://developers.google.com/identity/images/g-logo.png" alt="Google Logo"> 
                        </span>
                       <span class="ms-2">
                        Đăng nhập
                        bằng Google
